...
--data '{"catalogid": "sf-beta","startinglineagename": "PolicyCenter (/PolicyCenter-PL)","assetrelnames": "callsTo/calledBy", "dataassetrelnames":"callsTo/calledBy","customerassettype":"WEB_REQUEST_SERVICE","platform":"TP2"}'
