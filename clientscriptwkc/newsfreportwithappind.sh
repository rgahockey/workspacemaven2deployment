...
--data '{"catalogid": "sf-beta","startinglineagename": "AAPEstimateActor","assetrelnames": "callsTo/calledBy", "dataassetrelnames":"callsTo/calledBy","customerassettype":"WEB_SERVICE","platform":"TP2","appid" : "AAPEstimateActor-v*-checkout"}'
