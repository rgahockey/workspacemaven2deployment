...
--data '{"catalogid": "sf-beta","startinglineagename": "ClusterManagementIntegrator-1 (/ClusterManagementIntegrator)","assetrelnames": "callsTo/calledBy", "dataassetrelnames":"callsTo/calledBy","customerassettype":"WEB_SERVICE","platform":"TP2"}'
